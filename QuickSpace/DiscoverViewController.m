...
- (void)viewDidLoad
{
    ...
    popularPlaces = [NSArray arrayWithObjects:@"Stanford", @"San Francisco", @"Los Angeles", @"My Location", nil];
    popularPlacesImg = [NSArray arrayWithObjects:@"stanford.png", @"san_francisco.png", @"los_angeles.png", @"san_francisco.png", nil];
    didUseSearch = NO;
...
- (void)prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender
{
    ...
    if (didUseSearch){
        ...
        if([city isEqualToString:@"Stanford"]){
            ...
            destViewController.useCurrLocation = YES;
